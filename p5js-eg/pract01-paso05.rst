...
Práctica 01 — Paso 5: Color que cambia con el ratón
====================================================
...
.. admonition:: colorMode()
   ...
   de p5.js, están ampliamente descritos en la documentación oficial:
   `https://p5js.org/reference/ <https://p5js.org/reference/>`_
